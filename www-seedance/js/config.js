...
var C={API:isLocal?location.origin+'/api/v1':'https://api.atlascloud.ai/api/v1',UPLOAD:isLocal?location.origin+'/api/upload-image':null,GEN:'/model/generateVideo',POLL:'/model/prediction/',MODELS:{text:{fast:'bytedance/seedance-2.0-fast/text-to-video',standard:'bytedance/seedance-2.0/text-to-video'},image:{fast:'bytedance/seedance-2.0-fast/image-to-video',standard:'bytedance/seedance-2.0/image-to-video'}},PRICE:{fast:0.7,standard:0.9},POLL_INTERVAL:3000,MAX_POLL:600000};
